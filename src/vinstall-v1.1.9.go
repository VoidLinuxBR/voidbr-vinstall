/*
    ...
    Updated:   ter 03 fev 2026 15:45:30 -04
    Version:   1.1.9-20260203
...
func printUsage() {
	...
	fmt.Println(white("Exemplos:"))
	fmt.Printf("  %s %s\n", green("vinstall"), white("telegram-desktop"))
	fmt.Printf("  %s %s\n", green("vinstall"), white("-Syu"))
	fmt.Printf("  %s %s\n", green("vinstall"), white("-f yasm"))
	fmt.Printf("  %s %s\n", green("vinstall"), white("-S telegram"))
	fmt.Println()
}
