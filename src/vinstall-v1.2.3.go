...
func fetchSuggestions(query string) []Package {
	// Usamos -Rs para buscar em repositórios remotos, que é o comportamento padrão esperado
	...
	for _, line := range lines {
		...
		if len(parts) >= 2 {
			...
			// Pegamos a descrição preservando espaços originais
			description := ""
